...
create_graphics_pipeline :: proc (gpu: ^Gpu, set_layouts: [] vk.DescriptorSetLayout, shaders: [] Shader, $PC: typeid, old: Pipeline) -> Pipeline {
    ...
    create_info := vk.GraphicsPipelineCreateInfo {
        ...
        pNext = &vk.PipelineRenderingCreateInfo {
            ...
            pColorAttachmentFormats = &gpu.color_buffer.format,
            depthAttachmentFormat   = gpu.depth_buffer.format,
    ...
    result.update_template = create_update_template(gpu.device, .GRAPHICS, result.layout, ..shaders)
