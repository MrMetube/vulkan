...
generate_shader_api :: proc (output_file: string) {
    ...
    append_simple_struct(&builder, Cluster_Count)
    ...
    collect_types(&simple_types, &reference_types, Cluster_Cull_Data)
    ...
    append_buffer_reference_struct(&builder, Cluster_Cull_Data)
